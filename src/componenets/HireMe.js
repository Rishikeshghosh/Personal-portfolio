...
const HireMe = () => {
  return (
    <div className="absolute   bottom-[25px] left-[1078px] top-[60px] flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute xs:absolute xs:right-3">
