...
const HireMe = () => {
  return (
    <div className="absolute  left-[55px] bottom-[25px] right-[-1000px] top-[60px] flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute xs:absolute xs:right-3">
