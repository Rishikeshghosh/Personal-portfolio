...
const Skills = () => {
  return (
    <>
      ...
      <div
        className="w-full b h-screen relative flex items-center justify-center bg-circularLight black:bg-circularDark
      ...
      >
        ...
        <Skill name="JAVASCRIPT" x="-28vw" y="2vw" />
        ...
        <Skill name="VISUAL STUDIO CODE" x="0vw" y="-20vw" />
