...
const Education = () => {
  ...
  return (
    <div className="xs:mt-[190px] my-64 ">
      <h2 className=" font-bold text-8xl mb-32 w-full text-center xs:text-4xl xs:mb-16 xs:ml-[58px]">
        Education
      </h2>
      ...
      >
        ...
        />
        <ul className="w-full  flex flex-col items-start justify-between ml-4 xs:m-2   ">
          <Deatils
